...
WORKING_DIR=`pwd`
ENSEMBL_CONFIG_BASE=`realpath $WORKING_DIR`
...
echo "Ensembl Config files and script Files are under ${ENSEMBL_CONFIG_BASE}"| tee -a $LOG_FILE
echo "Files generated by this script are under ${ENSEMBL_BASE}"| tee -a $LOG_FILE
echo "File: current_README"| tee -a $LOG_FILE

export ENSEMBL_CONFIG_BASE
