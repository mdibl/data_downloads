...
# readme file of Wormbase database
#
# What it does:
...
SRC_CONFIG=wormbase.cfg
README_CONFIG=ftp.wormbase.org.current_readme.cfg
...
release_token="New release of WormBase"
RELEASE_NUMBER=`head ${SRC_BASE}/$CURRENT_README | grep "$release_token" | sed -e "s/$release_token//"`
