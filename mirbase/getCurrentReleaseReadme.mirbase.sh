...
# readme file of mirbase database
#
# What it does:
...
SRC_CONFIG=mirbase.cfg
README_CONFIG=mirbase.org.current_readme.cfg
...
release_token="The miRBase Sequence Database -- Release"
...
RELEASE_NUMBER=`head ${SRC_BASE}/$CURRENT_README | grep "$release_token" |sed "s/$release_token//"`
